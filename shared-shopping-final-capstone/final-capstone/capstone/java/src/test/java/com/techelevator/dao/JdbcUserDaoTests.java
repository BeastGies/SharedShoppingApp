...
public class JdbcUserDaoTests extends BaseDaoTests {
    protected static final User USER_1 = new User(1, "user1first", "user1last", "user1", "user1", "ROLE_USER","user1@mail.com");
    protected static final User USER_2 = new User(2, "user2first", "user2last", "user2", "user2", "ROLE_USER", "user2@mail.com");
    private static final User USER_3 = new User(3, "user3first", "user3last", "user3", "user3", "ROLE_USER", "user3@mail.com");
    ...
    public void create_user_with_null_username() {
        ...
        sut.create(USER_3.getFirstName(), USER_3.getLastName(), null, USER_3.getPassword(), "ROLE_USER", USER_3.getEmail() );
    }

    @Test(expected = DataIntegrityViolationException.class)
    public void create_user_with_existing_username() {
        sut.create(USER_1.getFirstName(), USER_1.getLastName(), USER_1.getUsername(), USER_3.getPassword(), "ROLE_USER", USER_1.getEmail());

    }

    @Test(expected = IllegalArgumentException.class)
    public void create_user_with_null_password() {
        sut.create(USER_3.getFirstName(), USER_3.getLastName(), USER_3.getUsername(), null, "ROLE_USER", USER_3.getEmail());
    }

    @Test
    public void create_user_creates_a_user() {
        User newUser = new User(-1, "newfirst", "newlast", "new", "user", "ROLE_USER", "new@mail.com");
